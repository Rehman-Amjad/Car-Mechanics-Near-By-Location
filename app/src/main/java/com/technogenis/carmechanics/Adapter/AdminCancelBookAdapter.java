...
import com.technogenis.carmechanics.AdminPanal.AdminBookDetailsActivity;
import com.technogenis.carmechanics.Model.BookModel;
import com.technogenis.carmechanics.R;

import java.util.List;

public class AdminCancelBookAdapter extends RecyclerView.Adapter<AdminCancelBookAdapter.MyViewHolder>{

    private Context context;
    private List<BookModel> mDataList;

    public AdminCancelBookAdapter(Context context, List<BookModel> mDataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(v -> {
            ...
            intent.putExtra("bookGarageName",model.getBookGarageMarqueeName());
            intent.putExtra("bookGarageAddress",model.getBookGarageAddress());
            intent.putExtra("bookGarageContact",model.getBookGarageContact());
