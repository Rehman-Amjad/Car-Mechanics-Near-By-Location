...
import com.technogenis.carmechanics.AdminAppMain.UserActivity;
import com.technogenis.carmechanics.Model.UserModel;
import com.technogenis.carmechanics.R;

import java.util.List;

public class UserListAdapter extends RecyclerView.Adapter<UserListAdapter.MyViewFinderHolder>
{
        ...
        holder.delete_image.setOnClickListener(v -> {
            ...
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    FirebaseDatabase.getInstance().getReference().child("UsersAccounts")
