...
public class UserProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_save.setOnClickListener(v -> {
            ...
            progressDialog = ProgressDialog.show(UserProfileActivity.this, "", "Processing", true);
                                    ...
                                    String profileImageLink, String coverImageLink)
    {
        ...
        reference.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                {
                    progressDialog.dismiss();
                    Toast.makeText(UserProfileActivity.this, "Account Doesn't exist", Toast.LENGTH_SHORT).show();
                }
