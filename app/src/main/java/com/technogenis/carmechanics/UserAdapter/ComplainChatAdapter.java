...
public class ComplainChatAdapter extends RecyclerView.Adapter<ComplainChatAdapter.MyViewHolder>
{
    private Context context;
    private ArrayList<ChatModel> mDataList;

    public ComplainChatAdapter(Context context, ArrayList<ChatModel> mDataList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        if (model.getMessageType().equals("appOwner"))
        {
